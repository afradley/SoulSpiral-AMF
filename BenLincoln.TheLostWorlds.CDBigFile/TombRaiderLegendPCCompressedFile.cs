...
{
    public class TombRaiderLegendPCCompressedFile : BF.CompressedFile
    {
        public TombRaiderLegendPCCompressedFile(BF.BigFile parent, BF.Index parentIndex, uint[] rawIndexData, int hashNamePosition, int offsetPosition, int lengthPosition, int compressedLengthPosition)
            : base()
        {
            // Copied from File
            mNamePrefix = "";
            ...
            // Copied from CompressedFile
            mCompressedLength = (int)rawIndexData[compressedLengthPosition];
            mCanBeReplaced = false;
        }

        public TombRaiderLegendPCCompressedFile(BF.BigFile parent, BF.Index parentIndex, uint[] rawIndexData, string hashedName, int offsetPosition, int lengthPosition, int compressedLengthPosition)
            : base()
        {
            // Copied from File
            mParentBigFile = parent;
